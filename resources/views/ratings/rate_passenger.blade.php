    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="bg-yellow-500 text-white px-6 py-4">
                <h2 class="text-xl font-bold">تقييم الراكب</h2>
            </div>
            ...
            <div class="p-6">
                <div class="mb-6 bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="text-gray-600">الراكب:</p>
                ...
                <form action="{{ route('ratings.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="w-full border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring focus:ring-yellow-200" 
                            id="comment" name="comment" rows="3" placeholder="أخبرنا عن تجربتك مع هذا الراكب...">{{ old('comment') }}</textarea>
                        @error('comment')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
